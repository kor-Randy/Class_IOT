...
char WIFI_PASSWORD[]= "";
char HOST_ADDRESS[]=“a3dlvhhpdzs81h-ats.iot.ap-northeast-2.amazonaws.com";
char CLIENT_ID[]= "wlgusdnIOT";
char TOPIC_NAME_update[]= "$aws/things/wlgusdnIOT/shadow/update";
char TOPIC_NAME_delta[]= "$aws/things/wlgusdnIOT/shadow/update/delta";
